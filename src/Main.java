...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Mamifero leon = new Leon(120d, 5, 7.5f, 58, "Sudáfrica", 120, 220, 190);
        Mamifero tigre = new Tigre("Siberiano", 7.9f, 72, "Siberia", 130, 330, 300);
        Mamifero lobo = new Lobo(9, "Ibérico", 2.5f, "Gris marrón y negro", "Europa", 80, 120, 70);
        Mamifero perro = new Perro(317, 2.5f, "Tricolor de manchas negras, blancas y óxido", "Colombia", 43, 70, 15);
